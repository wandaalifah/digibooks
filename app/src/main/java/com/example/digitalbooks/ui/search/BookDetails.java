...
public class BookDetails extends AppCompatActivity {
    ...
    String title, publisher, publishedDate, description, thumbnail, previewLink, infoLink, buyLink;
    int pageCount;
        ...
        buyBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (buyLink.isEmpty()) {
                    ...
                    Toast.makeText(BookDetails.this, "The book is out of stock", Toast.LENGTH_SHORT).show();
                    return;
                }
                // if the link is present we are opening
